                  ...
                  <div className="flex flex-col">
                    <div className="relative">
                      <input 
                        ...
                        placeholder=" "
                      />
                      <label htmlFor="nta2" className="absolute text-sm text-muted-foreground duration-300 transform -translate-y-3 scale-75 top-4 z-10 origin-[0] start-12 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-3 peer-focus:text-primary pointer-events-none">
